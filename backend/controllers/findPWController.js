...
exports.CheckId = async (req, res, next) => {
  ...
  id_check = await model.students
    .findAll({ where: { name: name, student_id: id } })
    .catch((err) => console.log(err)); //학번 체크
...
exports.findPW = async (req, res, next) => {
  ...
  result = await model.students
    .findAll({ where: { student_id: id, pw_answer: answer } })
    .catch((err) => console.log(err));
